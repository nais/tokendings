...
fun main() {
    ...
    val config = Configuration(
        ...
        tokenIssuerConfig = TokenIssuerConfig(serverConfig.ingress, tokenValidatorConfig, oauth2Clients(serverConfig))
    )
...
private fun oauth2Client(clientId: String): OAuth2Client {
    ...
    return OAuth2Client(clientId, jwkSet.toPublicJWKSet())
}
